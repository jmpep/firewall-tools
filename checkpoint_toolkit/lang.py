...
T = {
    ...
    "dlg.progress.connected_layers": {"en": "Connected \u2014 fetching layers",
        ...
        "de": "Verbunden \u2014 Ebenen werden abgerufen",
        "it": "Connesso \u2014 caricamento layer",
        "sk": "Pripojen\u00e9 \u2014 na\u010d\u00edtavam vrstvy"},
    "dlg.progress.layers_found": {"en": "Found {count} layer(s)",
        "fr": "{count} couche(s) trouv\u00e9e(s)",
        "de": "{count} Ebene(n) gefunden",
        "it": "{count} layer trovati",
        "sk": "N\u00e1jden\u00fdch {count} vrstiev"},
    ...
    "dlg.progress.layer": {"en": "Layer {n}/{total}: {name}",
        "fr": "Couche {n}/{total} : {name}",
        "de": "Ebene {n}/{total}: {name}",
        "it": "Layer {n}/{total}: {name}",
        "sk": "Vrstva {n}/{total}: {name}"},
    ...
    "dlg.progress.fetching_threat": {"en": "Fetching threat prevention rules",
        "fr": "R\u00e9cup\u00e9ration des r\u00e8gles de pr\u00e9vention des menaces",
        "de": "Bedrohungspr\u00e4ventionsregeln abrufen",
        "it": "Scaricamento regole prevenzione minacce",
        "sk": "Na\u010d\u00edtavam pravidl\u00e1 prevencie hrozieb"},
